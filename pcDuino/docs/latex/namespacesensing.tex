...
This is where the program will spend the majority of its time, looping through indefinitely. \hypertarget{namespacesensing_a38d7f8a9b27bbcf471a89725a5e78493}{\index{sensing@{sensing}!main@{main}}
...
Any sensor that is not on that specific board should be commented out from this function to prevent garbage values. 
\begin{DoxyExceptions}{Exceptions}
{\em \hyperlink{classsensing_1_1_no_pin_files_exception}{No\-Pin\-Files\-Exception}} & This exception will be thrown when the files to read pins are not present, most likely indicating that the code is not being run on a pc\-Duino. \\
\hline
\end{DoxyExceptions}
